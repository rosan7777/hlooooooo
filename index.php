...
if (!empty($products_review)) {
    $num_to_select = min(8, count($products_review));
    $selected_indices = array_rand($products_review, $num_to_select);
        ...
        <div id="navbarMenu" class="navbar-menu">
            ...
            <div class="navbar-end">
                ...
                <?php if (isset($_SESSION["USER_ID"])): ?>
                    <div class="navbar-item">
                        <span class="has-text-weight-semibold">Welcome, <?php echo htmlspecialchars($_SESSION["FIRST_NAME"] . " " . $_SESSION["LAST_NAME"]); ?></span>
                    </div>
                    <div class="navbar-item">
